...
* 3.6   ms   01/23/17 Added log_debug statement in main function for all
...
#ifndef ETH_INTS_H			/* prevent circular inclusions */
#define ETH_INTS_H			/* by using protection macros */
