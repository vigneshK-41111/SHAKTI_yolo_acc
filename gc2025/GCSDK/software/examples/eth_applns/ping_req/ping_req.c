...
#define ICMP_KNOWN_DATA_LEN	64	/* ICMP known data length */
 ...
 */
/* ifconfig enp1s0 172.16.63.61 netmask 255.255.255.0 up */
...
u16 IcmpData[ICMP_KNOWN_DATA_LEN] =
{
	...
	0x9192, 0x9394, 0x9596, 0x9798, 0x999a,  0x9b9c, 0x9d9e, 0x9fa0
};
