...
// mv_word_select_blocknum        I     4
// mv_word_select_wayselect       I     1 unused
// mv_line_select_wayselect       I     1 unused
// EN_ma_request                  I     1
...
module mkdcache_data(CLK,
  ...
  wire [511 : 0] lv_selected_line__h10849, x__h9383;
  wire [8 : 0] block_offset__h9312;
  ...
  // actionvalue method mv_word_select
  assign mv_word_select = { x__h9383[31:0], lv_selected_line__h10849 } ;
  ...
  assign v_data_0_ram_single_0_wea = ma_request_read_write ;
  assign v_data_0_ram_single_0_ena = EN_ma_request && ma_request_banks[0] ;

  // submodule v_data_0_ram_single_1
  assign v_data_0_ram_single_1_addra = ma_request_index ;
  assign v_data_0_ram_single_1_dina = ma_request_dataline[63:32] ;
  assign v_data_0_ram_single_1_wea = ma_request_read_write ;
  assign v_data_0_ram_single_1_ena = EN_ma_request && ma_request_banks[1] ;

  // submodule v_data_0_ram_single_10
  assign v_data_0_ram_single_10_addra = ma_request_index ;
  assign v_data_0_ram_single_10_dina = ma_request_dataline[351:320] ;
  assign v_data_0_ram_single_10_wea = ma_request_read_write ;
  assign v_data_0_ram_single_10_ena = EN_ma_request && ma_request_banks[10] ;

  // submodule v_data_0_ram_single_11
  assign v_data_0_ram_single_11_addra = ma_request_index ;
  assign v_data_0_ram_single_11_dina = ma_request_dataline[383:352] ;
  assign v_data_0_ram_single_11_wea = ma_request_read_write ;
  assign v_data_0_ram_single_11_ena = EN_ma_request && ma_request_banks[11] ;

  // submodule v_data_0_ram_single_12
  assign v_data_0_ram_single_12_addra = ma_request_index ;
  assign v_data_0_ram_single_12_dina = ma_request_dataline[415:384] ;
  assign v_data_0_ram_single_12_wea = ma_request_read_write ;
  assign v_data_0_ram_single_12_ena = EN_ma_request && ma_request_banks[12] ;

  // submodule v_data_0_ram_single_13
  assign v_data_0_ram_single_13_addra = ma_request_index ;
  assign v_data_0_ram_single_13_dina = ma_request_dataline[447:416] ;
  assign v_data_0_ram_single_13_wea = ma_request_read_write ;
  assign v_data_0_ram_single_13_ena = EN_ma_request && ma_request_banks[13] ;

  // submodule v_data_0_ram_single_14
  assign v_data_0_ram_single_14_addra = ma_request_index ;
  assign v_data_0_ram_single_14_dina = ma_request_dataline[479:448] ;
  assign v_data_0_ram_single_14_wea = ma_request_read_write ;
  assign v_data_0_ram_single_14_ena = EN_ma_request && ma_request_banks[14] ;

  // submodule v_data_0_ram_single_15
  assign v_data_0_ram_single_15_addra = ma_request_index ;
  assign v_data_0_ram_single_15_dina = ma_request_dataline[511:480] ;
  assign v_data_0_ram_single_15_wea = ma_request_read_write ;
  assign v_data_0_ram_single_15_ena = EN_ma_request && ma_request_banks[15] ;

  // submodule v_data_0_ram_single_2
  assign v_data_0_ram_single_2_addra = ma_request_index ;
  assign v_data_0_ram_single_2_dina = ma_request_dataline[95:64] ;
  assign v_data_0_ram_single_2_wea = ma_request_read_write ;
  assign v_data_0_ram_single_2_ena = EN_ma_request && ma_request_banks[2] ;

  // submodule v_data_0_ram_single_3
  assign v_data_0_ram_single_3_addra = ma_request_index ;
  assign v_data_0_ram_single_3_dina = ma_request_dataline[127:96] ;
  assign v_data_0_ram_single_3_wea = ma_request_read_write ;
  assign v_data_0_ram_single_3_ena = EN_ma_request && ma_request_banks[3] ;

  // submodule v_data_0_ram_single_4
  assign v_data_0_ram_single_4_addra = ma_request_index ;
  assign v_data_0_ram_single_4_dina = ma_request_dataline[159:128] ;
  assign v_data_0_ram_single_4_wea = ma_request_read_write ;
  assign v_data_0_ram_single_4_ena = EN_ma_request && ma_request_banks[4] ;

  // submodule v_data_0_ram_single_5
  assign v_data_0_ram_single_5_addra = ma_request_index ;
  assign v_data_0_ram_single_5_dina = ma_request_dataline[191:160] ;
  assign v_data_0_ram_single_5_wea = ma_request_read_write ;
  assign v_data_0_ram_single_5_ena = EN_ma_request && ma_request_banks[5] ;

  // submodule v_data_0_ram_single_6
  assign v_data_0_ram_single_6_addra = ma_request_index ;
  assign v_data_0_ram_single_6_dina = ma_request_dataline[223:192] ;
  assign v_data_0_ram_single_6_wea = ma_request_read_write ;
  assign v_data_0_ram_single_6_ena = EN_ma_request && ma_request_banks[6] ;

  // submodule v_data_0_ram_single_7
  assign v_data_0_ram_single_7_addra = ma_request_index ;
  assign v_data_0_ram_single_7_dina = ma_request_dataline[255:224] ;
  assign v_data_0_ram_single_7_wea = ma_request_read_write ;
  assign v_data_0_ram_single_7_ena = EN_ma_request && ma_request_banks[7] ;

  // submodule v_data_0_ram_single_8
  assign v_data_0_ram_single_8_addra = ma_request_index ;
  assign v_data_0_ram_single_8_dina = ma_request_dataline[287:256] ;
  assign v_data_0_ram_single_8_wea = ma_request_read_write ;
  assign v_data_0_ram_single_8_ena = EN_ma_request && ma_request_banks[8] ;

  // submodule v_data_0_ram_single_9
  assign v_data_0_ram_single_9_addra = ma_request_index ;
  assign v_data_0_ram_single_9_dina = ma_request_dataline[319:288] ;
  assign v_data_0_ram_single_9_wea = ma_request_read_write ;
  assign v_data_0_ram_single_9_ena = EN_ma_request && ma_request_banks[9] ;

  // remaining internal signals
  assign block_offset__h9312 = { mv_word_select_blocknum, 5'd0 } ;
  assign lv_selected_line__h10849 = mv_line_select ;
  assign x__h9383 = lv_selected_line__h10849 >> block_offset__h9312 ;
  ...
  begin
    #0;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_mv_line_select && !mv_line_select_wayselect)
	$display("Dynamic assertion failed: \"caches_mmu/src/dcache//dcache_lib.bsv\", line 648, column 45\nWayselect should be one-hot.");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_mv_line_select && !mv_line_select_wayselect) $finish(32'd0);
  end
  // synopsys translate_on
