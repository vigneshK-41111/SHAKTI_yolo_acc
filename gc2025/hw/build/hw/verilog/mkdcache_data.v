...
module mkdcache_data(CLK,
  ...
  wire [543 : 0] IF_mv_word_select_wayselect_BIT_1_91_THEN_v_da_ETC___d309,
		 IF_mv_word_select_wayselect_BIT_2_88_THEN_v_da_ETC___d310;
  wire [511 : 0] IF_mv_line_select_wayselect_BIT_2_13_THEN_v_da_ETC___d326,
		 lv_selected_line__h42124,
		 lv_selected_line__h42156,
		 lv_selected_line__h42188,
		 lv_selected_line__h42220,
		 x__h36591,
		 x__h37905,
		 x__h39218,
		 x__h40531;
  wire [8 : 0] block_offset__h36497;
  wire [2 : 0] x__h36277,
	       x__h36289,
	       x__h36301,
	       x__h41850,
	       ...
	       y__h41863,
	       y__h41875;
  wire NOT_0_CONCAT_mv_word_select_wayselect_BIT_3_86_ETC___d198;
  ...
  assign mv_word_select =
	     mv_word_select_wayselect[3] ?
	       { x__h36591[31:0], lv_selected_line__h42124 } :
	       IF_mv_word_select_wayselect_BIT_2_88_THEN_v_da_ETC___d310 ;
  ...
  assign mv_line_select =
	     mv_line_select_wayselect[3] ?
	       lv_selected_line__h42124 :
	       IF_mv_line_select_wayselect_BIT_2_13_THEN_v_da_ETC___d326 ;
  ...
  // remaining internal signals
  assign IF_mv_line_select_wayselect_BIT_2_13_THEN_v_da_ETC___d326 =
	     mv_line_select_wayselect[2] ?
	       lv_selected_line__h42156 :
	       (mv_line_select_wayselect[1] ?
		  lv_selected_line__h42188 :
		  lv_selected_line__h42220) ;
  assign IF_mv_word_select_wayselect_BIT_1_91_THEN_v_da_ETC___d309 =
	     mv_word_select_wayselect[1] ?
	       { x__h39218[31:0], lv_selected_line__h42188 } :
	       { x__h40531[31:0], lv_selected_line__h42220 } ;
  assign IF_mv_word_select_wayselect_BIT_2_88_THEN_v_da_ETC___d310 =
	     mv_word_select_wayselect[2] ?
	       { x__h37905[31:0], lv_selected_line__h42156 } :
	       IF_mv_word_select_wayselect_BIT_1_91_THEN_v_da_ETC___d309 ;
  assign NOT_0_CONCAT_mv_word_select_wayselect_BIT_3_86_ETC___d198 =
	     x__h36277 + y__h36278 > 3'd1 ;
  assign block_offset__h36497 = { mv_word_select_blocknum, 5'd0 } ;
  assign lv_selected_line__h42124 =
  ...
  assign lv_selected_line__h42156 =
  ...
  assign lv_selected_line__h42188 =
  ...
  assign lv_selected_line__h42220 =
  ...
  assign x__h36277 = x__h36289 + y__h36290 ;
  assign x__h36289 = x__h36301 + y__h36302 ;
  assign x__h36301 = { 2'd0, mv_word_select_wayselect[3] } ;
  assign x__h36591 = lv_selected_line__h42124 >> block_offset__h36497 ;
  assign x__h37905 = lv_selected_line__h42156 >> block_offset__h36497 ;
  assign x__h39218 = lv_selected_line__h42188 >> block_offset__h36497 ;
  assign x__h40531 = lv_selected_line__h42220 >> block_offset__h36497 ;
  assign x__h41850 = x__h41862 + y__h41863 ;
  assign x__h41862 = x__h41874 + y__h41875 ;
  assign x__h41874 = { 2'd0, mv_line_select_wayselect[3] } ;
  assign y__h36278 = { 2'd0, mv_word_select_wayselect[0] } ;
  assign y__h36290 = { 2'd0, mv_word_select_wayselect[1] } ;
  assign y__h36302 = { 2'd0, mv_word_select_wayselect[2] } ;
  assign y__h41851 = { 2'd0, mv_line_select_wayselect[0] } ;
  assign y__h41863 = { 2'd0, mv_line_select_wayselect[1] } ;
  assign y__h41875 = { 2'd0, mv_line_select_wayselect[2] } ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  NOT_0_CONCAT_mv_word_select_wayselect_BIT_3_86_ETC___d198)
	...
	$finish(32'd0);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_mv_line_select && x__h41850 + y__h41851 != 3'd1)
	$display("Dynamic assertion failed: \"caches_mmu/src/dcache//dcache_lib.bsv\", line 649, column 45\nWayselect should be one-hot.");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_mv_line_select && x__h41850 + y__h41851 != 3'd1) $finish(32'd0);
  end
  // synopsys translate_on
