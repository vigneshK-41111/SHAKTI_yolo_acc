...
//
// On Mon Apr 27 13:13:51 IST 2026
//
//
// Ports:
// Name                         I/O  size props
...
module mkimem(pmp_cfg_0,
  ...
  wire [106 : 0] itlb_put_response_frm_ptw_put;
  wire [39 : 0] itlb_get_core_response_get;
  wire [35 : 0] itlb_get_request_to_ptw_get;
  wire [32 : 0] itlb_put_core_request_put;
  wire [31 : 0] itlb_ma_satp_from_csr_s;
  ...
  assign itlb_put_core_request_put =
	     { put_core_req_put[35:4], put_core_req_put[0] } ;
