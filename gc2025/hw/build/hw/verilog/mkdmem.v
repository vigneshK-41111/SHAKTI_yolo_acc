...
//
// On Mon Apr 27 13:14:10 IST 2026
//
//
// Ports:
// Name                         I/O  size props
...
module mkdmem(pmp_cfg_0,
  ...
  input  [80 : 0] receive_core_req_put;
  ...
  wire [78 : 0] dcache_send_core_io_resp;
  wire [77 : 0] dcache_get_ptw_resp_get, dcache_send_core_cache_resp_get;
  wire [76 : 0] dcache_get_hold_req_get, dcache_receive_core_req_put;
  wire [72 : 0] dcache_put_pa_from_tlb_put;
  ...
  wire [106 : 0] dtlb_put_response_frm_ptw_put;
  wire [72 : 0] dtlb_get_core_response_get;
  wire [45 : 0] dtlb_put_core_request_put;
  wire [35 : 0] dtlb_get_request_to_ptw_get;
  wire [31 : 0] dtlb_ma_mstatus_from_csr_m, dtlb_ma_satp_from_csr_s;
  ...
  assign dcache_receive_core_req_put =
	     { receive_core_req_put[80:49],
	       receive_core_req_put[44],
	       receive_core_req_put[48],
	       receive_core_req_put[43:42],
	       receive_core_req_put[47:45],
	       receive_core_req_put[41:10],
  ...
  assign dtlb_EN_put_core_request_put =
	     EN_receive_core_req_put && !receive_core_req_put[44] ;
  ...
  // remaining internal signals
  assign x__h1184 =
	     (receive_core_req_put[43:42] == 2'd2 &&
