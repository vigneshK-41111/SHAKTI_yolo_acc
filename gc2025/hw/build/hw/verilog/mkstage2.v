...
// common_ma_commit_rd_commit     I    38
// common_ma_csrs_csr             I   158
...
module mkstage2(CLK,
  ...
  output [38 : 0] rf_mv_op1;

  // value method rf_mv_op2
  output [38 : 0] rf_mv_op2;

  // value method rf_mv_op3
  output [38 : 0] rf_mv_op3;

  // action method common_ma_commit_rd
  input  [37 : 0] common_ma_commit_rd_commit;
  ...
  input  [157 : 0] common_ma_csrs_csr;
  ...
  wire [38 : 0] rf_mv_op1, rf_mv_op2, rf_mv_op3;
  ...
  wire [31 : 0] mtval___1__h3855, x1_data__h5323;
  wire [7 : 0] chk_interrupt___d52;
  wire [6 : 0] _theResult___fst__h3200,
	       _theResult___fst__h3226,
	       func_cause__h2708;
  wire [3 : 0] IF_rg_microtrap_5_OR_chk_interrupt_2_BIT_0_3_A_ETC___d62;
  wire IF_rg_microtrap_5_OR_chk_interrupt_2_BIT_0_3_A_ETC___d75,
       eEpoch_read__9_CONCAT_wEpoch_read__0_1_EQ_IF_r_ETC___d44,
       eEpoch_read__9_CONCAT_wEpoch_read__0_1_EQ_IF_r_ETC___d81,
       rg_step_done__h3171,
       rx_pipe1_w_rdy_wget_AND_wr_csrs_whas_AND_wr_de_ETC___d15,
       wr_resume_wfi_whas__36_AND_wr_resume_wfi_wget__ETC___d142;
  ...
  // value method tx_tx_mtval_to_stage3_enq_data
  always@(func_cause__h2708 or rx_rx_from_stage1_first_x)
  begin
    case (func_cause__h2708)
      ...
      default: tx_tx_mtval_to_stage3_enq_data = 32'd0;
    endcase
  end
  ...
  assign tx_tx_instrtype_to_stage3_enq_data =
	     (IF_rg_microtrap_5_OR_chk_interrupt_2_BIT_0_3_A_ETC___d62 ==
	      4'd7) ?
	       4'd0 :
	       IF_rg_microtrap_5_OR_chk_interrupt_2_BIT_0_3_A_ETC___d62 ;
  ...
  assign MUX_rg_wfi_write_1__SEL_1 =
	     WILL_FIRE_RL_decode_and_opfetch &&
	     eEpoch_read__9_CONCAT_wEpoch_read__0_1_EQ_IF_r_ETC___d44 &&
	     IF_rg_microtrap_5_OR_chk_interrupt_2_BIT_0_3_A_ETC___d75 ;
  ...
  assign rg_op1_port0__write_1 =
	     { 1'd1, fn_decode___d36[64:60], registerfile_read_rs1, wEpoch } ;
  ...
  assign rg_op2_port0__write_1 =
	     { 1'd1, fn_decode___d36[59:55], op2__h3057, wEpoch } ;
  ...
  assign rg_op2type_port1__read =
	     MUX_rg_microtrap_write_1__SEL_2 ?
	       ...
	       rg_op2type ;
  assign rg_op3_port0__write_1 = { 6'd32, fn_decode___d36[39:8], wEpoch } ;
  ...
  // remaining internal signals
  module_fn_decode instance_fn_decode_1(.fn_decode_inst(mtval___1__h3855),
  ...
  module_chk_interrupt instance_chk_interrupt_0(.chk_interrupt_prv(common_ma_csrs_csr[125:124]),
						...
						.chk_interrupt_step_done(rg_step_done__h3171),
						.chk_interrupt(chk_interrupt___d52));
  assign IF_rg_microtrap_5_OR_chk_interrupt_2_BIT_0_3_A_ETC___d62 =
	     (rg_microtrap ||
	      chk_interrupt___d52[0] && fn_decode___d36[46:43] != 4'd7 ||
	      rx_rx_from_stage1_first_x[7]) ?
	       4'd6 :
	       fn_decode___d36[46:43] ;
  assign IF_rg_microtrap_5_OR_chk_interrupt_2_BIT_0_3_A_ETC___d75 =
	     IF_rg_microtrap_5_OR_chk_interrupt_2_BIT_0_3_A_ETC___d62 ==
	     4'd7 &&
	     !EN_common_ma_update_eEpoch &&
	     !EN_common_ma_update_wEpoch ;
  assign _theResult___fst__h3200 =
	     (chk_interrupt___d52[0] && fn_decode___d36[46:43] != 4'd7) ?
	       chk_interrupt___d52[7:1] :
	       _theResult___fst__h3226 ;
  assign _theResult___fst__h3226 =
	     rx_rx_from_stage1_first_x[7] ?
  ...
  assign eEpoch_read__9_CONCAT_wEpoch_read__0_1_EQ_IF_r_ETC___d81 =
	     eEpoch_read__9_CONCAT_wEpoch_read__0_1_EQ_IF_r_ETC___d44 &&
	     (rg_step_done && debug_debug_status_status[3] || !rg_microtrap) ;
  assign func_cause__h2708 =
	     rg_microtrap ? rg_microtrap_cause : _theResult___fst__h3200 ;
  assign mtval___1__h3855 = rx_rx_from_stage1_first_x[41:10] ;
  assign rg_step_done__h3171 = rg_step_done ;
  assign rx_pipe1_w_rdy_wget_AND_wr_csrs_whas_AND_wr_de_ETC___d15 =
	     ...
	     tx_tx_instrtype_to_stage3_enq_rdy_b &&
	     tx_tx_opmeta_to_stage3_enq_rdy_b ;
  assign wr_resume_wfi_whas__36_AND_wr_resume_wfi_wget__ETC___d142 =
	     EN_common_ma_resume_wfi && common_ma_resume_wfi_w ||
	     EN_common_ma_update_wEpoch ||
	     EN_common_ma_update_eEpoch ;
  assign x1_data__h5323 =
  ...
  begin
    case (fn_decode___d36[48:47])
      2'd0: op2__h3057 = registerfile_read_rs2;
      2'd1: op2__h3057 = fn_decode___d36[39:8];
      2'd2: op2__h3057 = 32'd4;
      2'd3: op2__h3057 = 32'd2;
    endcase
  end
  ...
  begin
	...
	rg_op2 <= `BSV_ASSIGNMENT_DELAY 39'd0;
	rg_op2type <= `BSV_ASSIGNMENT_DELAY 2'd0;
	rg_op3 <= `BSV_ASSIGNMENT_DELAY 39'd0;
  ...
  begin
    ...
    rg_op2 = 39'h2AAAAAAAAA;
    rg_op2type = 2'h2;
    rg_op3 = 39'h2AAAAAAAAA;
    rg_stall = 1'h0;
    rg_step_done = 1'h0;
    rg_wfi = 1'h0;
    wEpoch = 1'h0;
