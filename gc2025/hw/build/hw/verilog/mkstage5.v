...
// common_mv_commit_rd            O    38
// RDY_common_mv_commit_rd        O     1
// common_mv_flush                O    34
...
// rx_rx_baseout_from_stage4_first_x  I    38
...
// rx_rx_fuid_from_stage4_first_x  I    40
...
//    EN_interrupts_ma_plic_meip) -> rx_rx_systemout_from_stage4_deq_ena
//   (debug_ma_debug_interrupt__int,
//    rx_rx_systemout_from_stage4_first_deq_rdy_b,
//    rx_rx_systemout_from_stage4_first_x,
...
//    EN_interrupts_ma_clint_msip,
//    EN_interrupts_ma_clint_mtip,
//    EN_interrupts_ma_plic_meip) -> csrs_mv_csrs_to_decode
//   (debug_ma_debug_interrupt__int,
//    interrupts_ma_clint_msip_intrpt,
//    interrupts_ma_clint_mtip_intrpt,
//    interrupts_ma_plic_meip_intrpt,
...
//    EN_interrupts_ma_clint_msip,
//    EN_interrupts_ma_clint_mtip,
//    EN_interrupts_ma_plic_meip) -> csrs_mv_resume_wfi
//   (rx_rx_systemout_from_stage4_first_deq_rdy_b,
//    rx_rx_systemout_from_stage4_first_x,
//    rx_rx_trapout_from_stage4_first_deq_rdy_b,
...
module mkstage5(CLK,
  ...
  input  [37 : 0] rx_rx_baseout_from_stage4_first_x;
  ...
  input  [39 : 0] rx_rx_fuid_from_stage4_first_x;
  ...
  output [37 : 0] common_mv_commit_rd;
  output RDY_common_mv_commit_rd;

  // value method common_mv_flush
  output [33 : 0] common_mv_flush;
  ...
  input  [100 : 0] cache_ma_io_response_r;
  ...
  output [157 : 0] csrs_mv_csrs_to_decode;
  ...
  reg [37 : 0] common_mv_commit_rd;
  wire [157 : 0] csrs_mv_csrs_to_decode;
  wire [33 : 0] common_mv_flush;
  wire [31 : 0] csrs_mv_csr_mstatus, debug_mv_csr_dcsr;
  ...
  wire [36 : 0] IF_IF_rx_memio_w_data_whas__02_THEN_NOT_rx_mem_ETC___d131;
  wire [31 : 0] x__h5349;
  ...
  wire IF_rx_memio_w_data_whas__02_THEN_NOT_rx_memio__ETC___d113,
       IF_rx_memio_w_data_whas__02_THEN_NOT_rx_memio__ETC___d144,
       IF_rx_memio_w_data_whas__02_THEN_rx_memio_w_da_ETC___d147,
       IF_rx_memio_w_data_whas__02_THEN_rx_memio_w_da_ETC___d151,
       rg_epoch_4_EQ_IF_rx_fuid_w_data_whas_THEN_rx_f_ETC___d17,
       rg_epoch_4_EQ_IF_rx_fuid_w_data_whas_THEN_rx_f_ETC___d31,
       rg_epoch_4_EQ_IF_rx_fuid_w_data_whas_THEN_rx_f_ETC___d44;
  ...
  // value method csrs_mv_resume_wfi
  assign csrs_mv_resume_wfi = x__h5349 != 32'd0 ;
  ...
  assign MUX_rx_fuid_w_ena_wset_1__SEL_2 =
	     WILL_FIRE_RL_rl_writeback_memop &&
	     (IF_rx_memio_w_data_whas__02_THEN_NOT_rx_memio__ETC___d113 ||
	      !rg_epoch_4_EQ_IF_rx_fuid_w_data_whas_THEN_rx_f_ETC___d17) ;
  ...
  assign MUX_wr_commit_wset_1__VAL_2 =
	     { !rg_epoch_4_EQ_IF_rx_fuid_w_data_whas_THEN_rx_f_ETC___d17 ||
	       ...
	       rg_epoch_4_EQ_IF_rx_fuid_w_data_whas_THEN_rx_f_ETC___d17 ?
		 IF_IF_rx_memio_w_data_whas__02_THEN_NOT_rx_mem_ETC___d131 :
		 { rx_rx_fuid_from_stage4_first_x[7:0],
		   29'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  } } ;
  ...
  assign MUX_wr_flush_wset_1__VAL_2 = { 1'd1, csr_mav_upd_on_ret, 1'd0 } ;
  assign MUX_wr_flush_wset_1__VAL_3 = { 1'd1, csr_mav_upd_on_trap, 1'd0 } ;
  ...
  // remaining internal signals
  assign IF_IF_rx_memio_w_data_whas__02_THEN_NOT_rx_mem_ETC___d131 =
	     rx_rx_memio_from_stage4_first_x[3] ?
	       (cache_ma_io_response_r[67] ?
		  { rx_rx_fuid_from_stage4_first_x[7:0],
		    29'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  } :
  ...
  assign IF_rx_memio_w_data_whas__02_THEN_NOT_rx_memio__ETC___d113 =
	     !rx_rx_memio_from_stage4_first_x[3] ||
	     rg_ioop_init && EN_cache_ma_io_response &&
	     cache_ma_io_response_r[100] ;
  assign IF_rx_memio_w_data_whas__02_THEN_NOT_rx_memio__ETC___d144 =
	     !rx_rx_memio_from_stage4_first_x[3] ||
	     rg_ioop_init && EN_cache_ma_io_response &&
	     cache_ma_io_response_r[100] &&
	     !cache_ma_io_response_r[67] ;
  assign IF_rx_memio_w_data_whas__02_THEN_rx_memio_w_da_ETC___d147 =
	     rx_rx_memio_from_stage4_first_x[3] &&
	     (EN_cache_ma_io_response && cache_ma_io_response_r[100] ||
	      !rg_ioop_init) ;
  assign IF_rx_memio_w_data_whas__02_THEN_rx_memio_w_da_ETC___d151 =
	     rx_rx_memio_from_stage4_first_x[3] && rg_ioop_init &&
	     EN_cache_ma_io_response &&
	     cache_ma_io_response_r[100] &&
	     cache_ma_io_response_r[67] ;
  assign rg_epoch_4_EQ_IF_rx_fuid_w_data_whas_THEN_rx_f_ETC___d17 =
	     rg_epoch == rx_rx_fuid_from_stage4_first_x[2] ;
  assign rg_epoch_4_EQ_IF_rx_fuid_w_data_whas_THEN_rx_f_ETC___d31 =
	     rg_epoch_4_EQ_IF_rx_fuid_w_data_whas_THEN_rx_f_ETC___d17 &&
	     (rx_rx_trapout_from_stage4_first_x[38:32] == 7'd2 ||
	      rx_rx_trapout_from_stage4_first_x[38:32] == 7'd1 ||
	      rx_rx_trapout_from_stage4_first_x[38:32] == 7'd3 ||
	      !rx_rx_trapout_from_stage4_first_x[39]) ;
  assign rg_epoch_4_EQ_IF_rx_fuid_w_data_whas_THEN_rx_f_ETC___d44 =
	     rg_epoch_4_EQ_IF_rx_fuid_w_data_whas_THEN_rx_f_ETC___d17 &&
	     rx_rx_trapout_from_stage4_first_x[39] &&
	     rx_rx_trapout_from_stage4_first_x[38:32] != 7'd2 &&
	     rx_rx_trapout_from_stage4_first_x[38:32] != 7'd1 &&
  ...
  assign x__h5349 = csr_sbread_mv_csr_mip & csr_sbread_mv_csr_mie ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  rg_epoch_4_EQ_IF_rx_fuid_w_data_whas_THEN_rx_f_ETC___d44)
	$display("Dynamic assertion failed: \"c-class/src/stage5.bsv\", line 202, column 32\nReceived unexpected Micro-Trap cause");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_writeback_trap &&
	  rg_epoch_4_EQ_IF_rx_fuid_w_data_whas_THEN_rx_f_ETC___d44)
	$finish(32'd0);
