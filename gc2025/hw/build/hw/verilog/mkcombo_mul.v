...
module mkcombo_mul(CLK,
  ...
  reg [31 : 0] rg_output_0;
  wire [31 : 0] rg_output_0_D_IN;
  wire rg_output_0_EN;
  ...
  wire sign1__h1850, sign2__h1851;
  ...
  // register rg_op1_0
  assign rg_op1_0_D_IN = { sign1__h1850 & ma_inputs_in1[31], ma_inputs_in1 } ;
  assign rg_op1_0_EN = EN_ma_inputs ;

  // register rg_op2_0
  assign rg_op2_0_D_IN = { sign2__h1851 & ma_inputs_in2[31], ma_inputs_in2 } ;
  ...
  // remaining internal signals
  assign sign1__h1850 = ma_inputs_funct3[1] ^ ma_inputs_funct3[0] ;
  assign sign2__h1851 = ma_inputs_funct3[1:0] == 2'd1 ;
  ...
  begin
	...
	rg_output_0 <= `BSV_ASSIGNMENT_DELAY 32'd0;
      end
    else
      begin
