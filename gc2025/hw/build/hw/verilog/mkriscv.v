...
//
// On Thu Apr 30 14:33:50 IST 2026
//
//
// Ports:
// Name                         I/O  size props
// s0_icache_to_icache_get        O    35
// RDY_s0_icache_to_icache_get    O     1
// RDY_s1_icache_inst_response_put  O     1 reg
// s3_cache_mv_memory_request_get  O    78
...
// s4_cache_memory_response_put   I   100
// interrupts_ma_clint_msip_intrpt  I     1
// interrupts_ma_clint_mtip_intrpt  I     1
// interrupts_ma_clint_mtime_mtime  I    64 unused
// interrupts_ma_plic_meip_intrpt  I     1
// s5_cache_ma_io_response_r      I   101
...
// EN_interrupts_ma_clint_mtime   I     1 unused
...
module mkriscv(resetpc,
  ...
  output [34 : 0] s0_icache_to_icache_get;
  ...
  output [77 : 0] s3_cache_mv_memory_request_get;
  ...
  input  [99 : 0] s4_cache_memory_response_put;
  ...
  input  [100 : 0] s5_cache_ma_io_response_r;
  ...
  wire [77 : 0] s3_cache_mv_memory_request_get;
  wire [34 : 0] s0_icache_to_icache_get;
  ...
  // inlined wires
  wire [38 : 0] wr_bypass_wget, wr_bypass_1_wget;

  // register rg_reset_cycle
  reg [7 : 0] rg_reset_cycle;
  wire [7 : 0] rg_reset_cycle_D_IN;
  ...
  wire [37 : 0] ff_baseout_D_IN, ff_baseout_D_OUT;
  wire ff_baseout_CLR,
       ff_baseout_DEQ,
       ff_baseout_EMPTY_N,
       ff_baseout_ENQ,
  ...
  wire [37 : 0] ff_baseout_1_D_IN, ff_baseout_1_D_OUT;
  ...
  wire [34 : 0] stage0_icache_to_icache_get;
  wire [32 : 0] stage0_common_ma_flush_fl;
  ...
  wire [157 : 0] stage2_common_ma_csrs_csr;
  wire [87 : 0] stage2_rx_rx_from_stage1_first_x;
  wire [62 : 0] stage2_tx_tx_meta_to_stage3_enq_data;
  wire [38 : 0] stage2_rf_mv_op1, stage2_rf_mv_op2, stage2_rf_mv_op3;
  wire [37 : 0] stage2_common_ma_commit_rd_commit;
  ...
  wire [77 : 0] stage3_bpu_mv_train_bpu,
		stage3_bypass_ma_bypass_fwd,
		stage3_cache_mv_memory_request_get;
  ...
  wire [40 : 0] stage3_tx_tx_fuid_to_stage4_enq_data;
  wire [39 : 0] stage3_tx_tx_trapout_to_stage4_enq_data;
  wire [38 : 0] stage3_rf_ma_op1_i, stage3_rf_ma_op2_i, stage3_rf_ma_op3_i;
  wire [37 : 0] stage3_common_ma_sb_release_commit,
  ...
  wire [37 : 0] stage4_rx_rx_baseout_from_stage3_first_x,
  ...
  wire [157 : 0] stage5_csrs_mv_csrs_to_decode;
  wire [100 : 0] stage5_cache_ma_io_response_r;
  wire [63 : 0] stage5_interrupts_ma_clint_mtime_mtime;
  wire [48 : 0] stage5_rx_rx_systemout_from_stage4_first_x;
  wire [39 : 0] stage5_rx_rx_fuid_from_stage4_first_x,
		stage5_rx_rx_trapout_from_stage4_first_x;
  wire [37 : 0] stage5_common_mv_commit_rd,
		stage5_rx_rx_baseout_from_stage4_first_x;
  wire [36 : 0] stage5_rx_rx_memio_from_stage4_first_x;
  wire [33 : 0] stage5_common_mv_flush;
  wire [31 : 0] stage5_csrs_mv_csr_mstatus, stage5_debug_mv_csr_dcsr;
  ...
  // register rg_reset_cycle
  assign rg_reset_cycle_D_IN = rg_reset_cycle + 8'd1 ;
  assign rg_reset_cycle_EN =
	     rg_reset_cycle == 8'd128 || rg_reset_cycle < 8'd128 ;

  // register rg_reset_done
  assign rg_reset_done_D_IN = 1'd1 ;
  assign rg_reset_done_EN = rg_reset_cycle == 8'd128 ;

  // register rg_reset_event
  assign rg_reset_event_D_IN = rg_reset_cycle == 8'd128 ;
  ...
  assign stage0_common_ma_flush_fl =
	     { stage5_common_mv_flush[0], fl_pc__h10070 } ;
  ...
  begin
    if (RST_N == `BSV_RESET_VALUE)
      begin
        rg_reset_cycle <= `BSV_ASSIGNMENT_DELAY 8'd0;
