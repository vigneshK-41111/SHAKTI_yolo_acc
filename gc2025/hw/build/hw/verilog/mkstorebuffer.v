...
//
// On Tue Apr 21 12:01:51 IST 2026
//
//
// Ports:
// Name                         I/O  size props
...
module mkstorebuffer(CLK,
  ...
  reg [102 : 0] v_sb_meta_0;
  wire [102 : 0] v_sb_meta_0_D_IN;
  wire v_sb_meta_0_EN;

  // register v_sb_meta_1
  reg [102 : 0] v_sb_meta_1;
  wire [102 : 0] v_sb_meta_1_D_IN;
  wire v_sb_meta_1_EN;
  ...
  wire [102 : 0] MUX_v_sb_meta_0_write_1__VAL_1,
		 MUX_v_sb_meta_0_write_1__VAL_2;
  wire MUX_v_sb_meta_0_write_1__SEL_1, MUX_v_sb_meta_1_write_1__SEL_1;

  // remaining internal signals
  reg [31 : 0] CASE_rg_head_0_v_sb_meta_0_BITS_102_TO_71_1_v__ETC__q6,
	       rs2__h1798,
	       temp__h11033,
	       x__h12468,
	       x__h1565,
  ...
  wire [31 : 0] n__h2517,
		...
		y__h10526,
		y__h10785;
  wire [4 : 0] shiftamt__h11032, shiftamt__h2492;
  ...
  assign wr_sb_meta_wget =
	     { CASE_rg_head_0_v_sb_meta_0_BITS_102_TO_71_1_v__ETC__q6,
	       x__h1565,
	       SEL_ARR_v_sb_meta_0_BIT_38_2_v_sb_meta_1_BIT_3_ETC___d29 } ;
  ...
  // register rg_head
  assign rg_head_D_IN = !rg_head && x__h13181 ;
  ...
  // register rg_tail
  assign rg_tail_D_IN = !rg_tail && x__h12533 ;
  ...
  assign NOT_SEL_ARR_NOT_v_sb_valid_0_read__17_73_NOT_v_ETC___d177 =
	     !CASE_rg_tail_0_NOT_v_sb_valid_0_1_NOT_v_sb_val_ETC__q1 ;
  assign SEL_ARR_v_sb_meta_0_BIT_38_2_v_sb_meta_1_BIT_3_ETC___d29 =
	     { CASE_rg_head_0_v_sb_meta_0_BIT_38_1_v_sb_meta__ETC__q2,
	       CASE_rg_head_0_v_sb_meta_0_BITS_37_TO_34_1_v_s_ETC__q3,
	       x__h1580,
  ...
  assign x__h10784 = x__h10525 & v_sb_meta_0[70:39] ;
  assign x__h12396 = temp__h11033 << shiftamt__h11032 ;
  assign x__h12533 = rg_tail + 1'd1 ;
  assign x__h13181 = rg_head + 1'd1 ;
  ...
  assign y__h10526 =
	     rg_tail ?
	       n__h2517 :
	       v_sb_meta_1_BITS_33_TO_2_1_AND_v_sb_meta_1_BIT_ETC___d156 ;
  assign y__h10785 = y__h10526 & v_sb_meta_1[70:39] ;
  always@(ma_allocate_entry_size or ma_allocate_entry_data)
  begin
    case (ma_allocate_entry_size)
      2'd0: x__h12468 = {4{ma_allocate_entry_data[7:0]}};
      2'd1: x__h12468 = {2{ma_allocate_entry_data[15:0]}};
      default: x__h12468 = ma_allocate_entry_data;
    endcase
  end
  always@(rg_head or v_sb_meta_0 or v_sb_meta_1)
  begin
    case (rg_head)
      1'd0: x__h1565 = v_sb_meta_0[70:39];
      1'd1: x__h1565 = v_sb_meta_1[70:39];
    endcase
  end
  always@(rg_head or v_sb_meta_0 or v_sb_meta_1)
  begin
  ...
  begin
    case (rg_atomic_tail)
      1'd0: x_addr__h2087 = v_sb_meta_0[102:71];
      1'd1: x_addr__h2087 = v_sb_meta_1[102:71];
    endcase
  end
  always@(rg_atomic_tail or v_sb_meta_0 or v_sb_meta_1)
  begin
    case (rg_atomic_tail)
      1'd0: x_epoch__h2088 = v_sb_meta_0[38];
      1'd1: x_epoch__h2088 = v_sb_meta_1[38];
    endcase
  end
  always@(rg_atomic_tail or v_sb_meta_0 or v_sb_meta_1)
  begin
    case (rg_atomic_tail)
      1'd0: x_fbindex__h2089 = v_sb_meta_0[37:34];
      1'd1: x_fbindex__h2089 = v_sb_meta_1[37:34];
    endcase
  end
  always@(rg_atomic_tail or v_sb_meta_0 or v_sb_meta_1)
  begin
    case (rg_atomic_tail)
      1'd0: rs2__h1798 = v_sb_meta_0[70:39];
      1'd1: rs2__h1798 = v_sb_meta_1[70:39];
    endcase
  end
  always@(ma_allocate_entry_size)
  begin
    case (ma_allocate_entry_size)
      2'd0: temp__h11033 = 32'h000000FF;
      2'd1: temp__h11033 = 32'h0000FFFF;
      default: temp__h11033 = 32'hFFFFFFFF;
    endcase
  end
  ...
  begin
	...
	v_sb_meta_0 <= `BSV_ASSIGNMENT_DELAY 103'd0;
	v_sb_meta_1 <= `BSV_ASSIGNMENT_DELAY 103'd0;
  ...
  begin
    ...
    v_sb_commit_0 = 1'h0;
    v_sb_commit_1 = 1'h0;
    v_sb_meta_0 = 103'h2AAAAAAAAAAAAAAAAAAAAAAAAA;
    v_sb_meta_1 = 103'h2AAAAAAAAAAAAAAAAAAAAAAAAA;
    v_sb_valid_0 = 1'h0;
    v_sb_valid_1 = 1'h0;
  end
