...
// spi1_io_mosi_outen             O     1 reg
// spi1_io_mosi_out               O     1 reg
// spi1_io_sclk_outen             O     1 reg
// spi1_io_sclk_out               O     1 reg
// spi1_io_miso_outen             O     1 reg
// spi1_io_miso_out               O     1 reg
// spi1_io_ncs_outen              O     1 reg
// spi1_io_ncs_out                O     1 reg
...
// spi2_sb_interrupt              O     1
// spi3_sb_interrupt              O     1
...
//   spi2_io_sclk_in_val -> spi2_sb_interrupt
//   spi3_io_sclk_in_val -> spi3_sb_interrupt
//
//
...
module mkspi_cluster(CLK,
  ...
  // value method spi0_io_ncs_outen
  output spi0_io_ncs_outen;

  // value method spi0_io_ncs_out
  output spi0_io_ncs_out;

  // action method spi0_io_ncs_in
  ...
  // value method spi1_io_ncs_outen
  output spi1_io_ncs_outen;

  // value method spi1_io_ncs_out
  output spi1_io_ncs_out;

  // action method spi1_io_ncs_in
  input  spi1_io_ncs_in_val;

  // value method spi2_io_mosi_outen
  output spi2_io_mosi_outen;

  // value method spi2_io_mosi_out
  output spi2_io_mosi_out;

  // action method spi2_io_mosi_in
  input  spi2_io_mosi_in_val;

  // value method spi2_io_sclk_outen
  output spi2_io_sclk_outen;

  // value method spi2_io_sclk_out
  output spi2_io_sclk_out;

  // action method spi2_io_sclk_in
  input  spi2_io_sclk_in_val;

  // value method spi2_io_miso_outen
  output spi2_io_miso_outen;

  // action method spi2_io_miso_in
  input  spi2_io_miso_in_val;

  // value method spi2_io_miso_out
  output spi2_io_miso_out;

  // value method spi2_io_ncs_outen
  output spi2_io_ncs_outen;

  // value method spi2_io_ncs_out
  output spi2_io_ncs_out;

  // action method spi2_io_ncs_in
  input  spi2_io_ncs_in_val;

  // value method spi3_io_mosi_outen
  output spi3_io_mosi_outen;

  // value method spi3_io_mosi_out
  output spi3_io_mosi_out;

  // action method spi3_io_mosi_in
  input  spi3_io_mosi_in_val;

  // value method spi3_io_sclk_outen
  output spi3_io_sclk_outen;

  // value method spi3_io_sclk_out
  output spi3_io_sclk_out;

  // action method spi3_io_sclk_in
  input  spi3_io_sclk_in_val;

  // value method spi3_io_miso_outen
  output spi3_io_miso_outen;

  // action method spi3_io_miso_in
  input  spi3_io_miso_in_val;

  // value method spi3_io_miso_out
  output spi3_io_miso_out;

  // value method spi3_io_ncs_outen
  output spi3_io_ncs_outen;

  // value method spi3_io_ncs_out
  output spi3_io_ncs_out;

  // action method spi3_io_ncs_in
  ...
  // value method spi2_sb_interrupt
  output spi2_sb_interrupt;

  // value method spi3_sb_interrupt
  output spi3_sb_interrupt;
  ...
  // ports of submodule spi2
  wire [31 : 0] spi2_slave_m_arvalid_araddr,
		spi2_slave_m_awvalid_awaddr,
		spi2_slave_m_wvalid_wdata,
		spi2_slave_rdata;
  wire [3 : 0] spi2_slave_m_wvalid_wstrb;
  wire [2 : 0] spi2_slave_m_arvalid_arprot, spi2_slave_m_awvalid_awprot;
  wire [1 : 0] spi2_slave_bresp,
	       spi2_slave_m_arvalid_arsize,
	       spi2_slave_m_awvalid_awsize,
	       spi2_slave_rresp;
  wire spi2_1io_miso_in_val,
       spi2_1io_miso_out,
       spi2_1io_miso_outen,
       spi2_1io_mosi_in_val,
       spi2_1io_mosi_out,
       spi2_1io_mosi_outen,
       spi2_1io_ncs_in_val,
       spi2_1io_ncs_out,
       spi2_1io_ncs_outen,
       spi2_1io_sclk_in_val,
       spi2_1io_sclk_out,
       spi2_1io_sclk_outen,
       spi2_sb_sspi_interrupt,
       spi2_slave_arready,
       spi2_slave_awready,
       spi2_slave_bvalid,
       spi2_slave_m_arvalid_arvalid,
       spi2_slave_m_awvalid_awvalid,
       spi2_slave_m_bready_bready,
       spi2_slave_m_rready_rready,
       spi2_slave_m_wvalid_wvalid,
       spi2_slave_rvalid,
       spi2_slave_wready;

  // ports of submodule spi3
  wire [31 : 0] spi3_slave_m_arvalid_araddr,
		spi3_slave_m_awvalid_awaddr,
		spi3_slave_m_wvalid_wdata,
		spi3_slave_rdata;
  wire [3 : 0] spi3_slave_m_wvalid_wstrb;
  wire [2 : 0] spi3_slave_m_arvalid_arprot, spi3_slave_m_awvalid_awprot;
  wire [1 : 0] spi3_slave_bresp,
	       spi3_slave_m_arvalid_arsize,
	       spi3_slave_m_awvalid_awsize,
	       spi3_slave_rresp;
  wire spi3_1io_miso_in_val,
       spi3_1io_miso_out,
       spi3_1io_miso_outen,
       spi3_1io_mosi_in_val,
       spi3_1io_mosi_out,
       spi3_1io_mosi_outen,
       spi3_1io_ncs_in_val,
       spi3_1io_ncs_out,
       spi3_1io_ncs_outen,
       spi3_1io_sclk_in_val,
       spi3_1io_sclk_out,
       spi3_1io_sclk_outen,
       spi3_sb_sspi_interrupt,
       spi3_slave_arready,
       spi3_slave_awready,
       spi3_slave_bvalid,
       spi3_slave_m_arvalid_arvalid,
       spi3_slave_m_awvalid_awvalid,
       spi3_slave_m_bready_bready,
       spi3_slave_m_rready_rready,
       spi3_slave_m_wvalid_wvalid,
       spi3_slave_rvalid,
       spi3_slave_wready;
  ...
  wire CAN_FIRE_RL_err_slave_receive_read_request,
       ...
       CAN_FIRE_spi0_io_ncs_in,
       CAN_FIRE_spi0_io_sclk_in,
       CAN_FIRE_spi1_io_miso_in,
       CAN_FIRE_spi1_io_mosi_in,
       CAN_FIRE_spi1_io_ncs_in,
       CAN_FIRE_spi1_io_sclk_in,
       CAN_FIRE_spi2_io_miso_in,
       CAN_FIRE_spi2_io_mosi_in,
       CAN_FIRE_spi2_io_ncs_in,
       CAN_FIRE_spi2_io_sclk_in,
       CAN_FIRE_spi3_io_miso_in,
       CAN_FIRE_spi3_io_mosi_in,
       CAN_FIRE_spi3_io_ncs_in,
       CAN_FIRE_spi3_io_sclk_in,
       ...
       WILL_FIRE_spi0_io_ncs_in,
       WILL_FIRE_spi0_io_sclk_in,
       WILL_FIRE_spi1_io_miso_in,
       WILL_FIRE_spi1_io_mosi_in,
       WILL_FIRE_spi1_io_ncs_in,
       WILL_FIRE_spi1_io_sclk_in,
       WILL_FIRE_spi2_io_miso_in,
       WILL_FIRE_spi2_io_mosi_in,
       WILL_FIRE_spi2_io_ncs_in,
       WILL_FIRE_spi2_io_sclk_in,
       WILL_FIRE_spi3_io_miso_in,
       WILL_FIRE_spi3_io_mosi_in,
       WILL_FIRE_spi3_io_ncs_in,
       WILL_FIRE_spi3_io_sclk_in;

  // remaining internal signals
  wire fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d106,
       fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d108,
       fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d119,
       fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d121,
       fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d124,
       fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d133,
       fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d135,
       fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d138,
       fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d149,
       fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d94,
       fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d96,
  ...
  // value method spi0_io_ncs_outen
  assign spi0_io_ncs_outen = spi0_1io_ncs_outen ;

  // value method spi0_io_ncs_out
  assign spi0_io_ncs_out = spi0_1io_ncs_out ;

  // action method spi0_io_ncs_in
  assign CAN_FIRE_spi0_io_ncs_in = 1'd1 ;
  assign WILL_FIRE_spi0_io_ncs_in = 1'd1 ;
  ...
  // value method spi1_io_ncs_outen
  assign spi1_io_ncs_outen = spi1_1io_ncs_outen ;

  // value method spi1_io_ncs_out
  assign spi1_io_ncs_out = spi1_1io_ncs_out ;

  // action method spi1_io_ncs_in
  assign CAN_FIRE_spi1_io_ncs_in = 1'd1 ;
  assign WILL_FIRE_spi1_io_ncs_in = 1'd1 ;

  // value method spi2_io_mosi_outen
  assign spi2_io_mosi_outen = spi2_1io_mosi_outen ;

  // value method spi2_io_mosi_out
  assign spi2_io_mosi_out = spi2_1io_mosi_out ;

  // action method spi2_io_mosi_in
  assign CAN_FIRE_spi2_io_mosi_in = 1'd1 ;
  assign WILL_FIRE_spi2_io_mosi_in = 1'd1 ;

  // value method spi2_io_sclk_outen
  assign spi2_io_sclk_outen = spi2_1io_sclk_outen ;

  // value method spi2_io_sclk_out
  assign spi2_io_sclk_out = spi2_1io_sclk_out ;

  // action method spi2_io_sclk_in
  assign CAN_FIRE_spi2_io_sclk_in = 1'd1 ;
  assign WILL_FIRE_spi2_io_sclk_in = 1'd1 ;

  // value method spi2_io_miso_outen
  assign spi2_io_miso_outen = spi2_1io_miso_outen ;

  // action method spi2_io_miso_in
  assign CAN_FIRE_spi2_io_miso_in = 1'd1 ;
  assign WILL_FIRE_spi2_io_miso_in = 1'd1 ;

  // value method spi2_io_miso_out
  assign spi2_io_miso_out = spi2_1io_miso_out ;

  // value method spi2_io_ncs_outen
  assign spi2_io_ncs_outen = spi2_1io_ncs_outen ;

  // value method spi2_io_ncs_out
  assign spi2_io_ncs_out = spi2_1io_ncs_out ;

  // action method spi2_io_ncs_in
  assign CAN_FIRE_spi2_io_ncs_in = 1'd1 ;
  assign WILL_FIRE_spi2_io_ncs_in = 1'd1 ;

  // value method spi3_io_mosi_outen
  assign spi3_io_mosi_outen = spi3_1io_mosi_outen ;

  // value method spi3_io_mosi_out
  assign spi3_io_mosi_out = spi3_1io_mosi_out ;

  // action method spi3_io_mosi_in
  assign CAN_FIRE_spi3_io_mosi_in = 1'd1 ;
  assign WILL_FIRE_spi3_io_mosi_in = 1'd1 ;

  // value method spi3_io_sclk_outen
  assign spi3_io_sclk_outen = spi3_1io_sclk_outen ;

  // value method spi3_io_sclk_out
  assign spi3_io_sclk_out = spi3_1io_sclk_out ;

  // action method spi3_io_sclk_in
  assign CAN_FIRE_spi3_io_sclk_in = 1'd1 ;
  assign WILL_FIRE_spi3_io_sclk_in = 1'd1 ;

  // value method spi3_io_miso_outen
  assign spi3_io_miso_outen = spi3_1io_miso_outen ;

  // action method spi3_io_miso_in
  assign CAN_FIRE_spi3_io_miso_in = 1'd1 ;
  assign WILL_FIRE_spi3_io_miso_in = 1'd1 ;

  // value method spi3_io_miso_out
  assign spi3_io_miso_out = spi3_1io_miso_out ;

  // value method spi3_io_ncs_outen
  assign spi3_io_ncs_outen = spi3_1io_ncs_outen ;

  // value method spi3_io_ncs_out
  assign spi3_io_ncs_out = spi3_1io_ncs_out ;

  // action method spi3_io_ncs_in
  assign CAN_FIRE_spi3_io_ncs_in = 1'd1 ;
  assign WILL_FIRE_spi3_io_ncs_in = 1'd1 ;
  ...
  // value method spi2_sb_interrupt
  assign spi2_sb_interrupt = spi2_sb_sspi_interrupt ;

  // value method spi3_sb_interrupt
  assign spi3_sb_interrupt = spi3_sb_sspi_interrupt ;
  ...
  mkspi spi0(.CLK(CLK),
	     ...
	     .io_ncs_in_val(spi0_1io_ncs_in_val),
	     ...
	     .io_ncs_outen(spi0_1io_ncs_outen),
	     .io_ncs_out(spi0_1io_ncs_out),
  ...
  mkspi spi1(.CLK(CLK),
	     ...
	     .io_ncs_in_val(spi1_1io_ncs_in_val),
	     ...
	     .io_ncs_outen(spi1_1io_ncs_outen),
	     .io_ncs_out(spi1_1io_ncs_out),
  ...
  mkspi spi2(.CLK(CLK),
	     .RST_N(RST_N),
	     .io_miso_in_val(spi2_1io_miso_in_val),
	     .io_mosi_in_val(spi2_1io_mosi_in_val),
	     .io_ncs_in_val(spi2_1io_ncs_in_val),
	     .io_sclk_in_val(spi2_1io_sclk_in_val),
	     .slave_m_arvalid_araddr(spi2_slave_m_arvalid_araddr),
	     .slave_m_arvalid_arprot(spi2_slave_m_arvalid_arprot),
	     .slave_m_arvalid_arsize(spi2_slave_m_arvalid_arsize),
	     .slave_m_arvalid_arvalid(spi2_slave_m_arvalid_arvalid),
	     .slave_m_awvalid_awaddr(spi2_slave_m_awvalid_awaddr),
	     .slave_m_awvalid_awprot(spi2_slave_m_awvalid_awprot),
	     .slave_m_awvalid_awsize(spi2_slave_m_awvalid_awsize),
	     .slave_m_awvalid_awvalid(spi2_slave_m_awvalid_awvalid),
	     .slave_m_bready_bready(spi2_slave_m_bready_bready),
	     .slave_m_rready_rready(spi2_slave_m_rready_rready),
	     .slave_m_wvalid_wdata(spi2_slave_m_wvalid_wdata),
	     .slave_m_wvalid_wstrb(spi2_slave_m_wvalid_wstrb),
	     .slave_m_wvalid_wvalid(spi2_slave_m_wvalid_wvalid),
	     .io_mosi_outen(spi2_1io_mosi_outen),
	     .io_mosi_out(spi2_1io_mosi_out),
	     .io_sclk_outen(spi2_1io_sclk_outen),
	     .io_sclk_out(spi2_1io_sclk_out),
	     .io_miso_outen(spi2_1io_miso_outen),
	     .io_miso_out(spi2_1io_miso_out),
	     .io_ncs_outen(spi2_1io_ncs_outen),
	     .io_ncs_out(spi2_1io_ncs_out),
	     .sb_sspi_interrupt(spi2_sb_sspi_interrupt),
	     .RDY_sb_sspi_interrupt(),
	     .slave_awready(spi2_slave_awready),
	     .slave_wready(spi2_slave_wready),
	     .slave_bvalid(spi2_slave_bvalid),
	     .slave_bresp(spi2_slave_bresp),
	     .slave_arready(spi2_slave_arready),
	     .slave_rvalid(spi2_slave_rvalid),
	     .slave_rresp(spi2_slave_rresp),
	     .slave_rdata(spi2_slave_rdata));

  // submodule spi3
  mkspi spi3(.CLK(CLK),
	     .RST_N(RST_N),
	     .io_miso_in_val(spi3_1io_miso_in_val),
	     .io_mosi_in_val(spi3_1io_mosi_in_val),
	     .io_ncs_in_val(spi3_1io_ncs_in_val),
	     .io_sclk_in_val(spi3_1io_sclk_in_val),
	     .slave_m_arvalid_araddr(spi3_slave_m_arvalid_araddr),
	     .slave_m_arvalid_arprot(spi3_slave_m_arvalid_arprot),
	     .slave_m_arvalid_arsize(spi3_slave_m_arvalid_arsize),
	     .slave_m_arvalid_arvalid(spi3_slave_m_arvalid_arvalid),
	     .slave_m_awvalid_awaddr(spi3_slave_m_awvalid_awaddr),
	     .slave_m_awvalid_awprot(spi3_slave_m_awvalid_awprot),
	     .slave_m_awvalid_awsize(spi3_slave_m_awvalid_awsize),
	     .slave_m_awvalid_awvalid(spi3_slave_m_awvalid_awvalid),
	     .slave_m_bready_bready(spi3_slave_m_bready_bready),
	     .slave_m_rready_rready(spi3_slave_m_rready_rready),
	     .slave_m_wvalid_wdata(spi3_slave_m_wvalid_wdata),
	     .slave_m_wvalid_wstrb(spi3_slave_m_wvalid_wstrb),
	     .slave_m_wvalid_wvalid(spi3_slave_m_wvalid_wvalid),
	     .io_mosi_outen(spi3_1io_mosi_outen),
	     .io_mosi_out(spi3_1io_mosi_out),
	     .io_sclk_outen(spi3_1io_sclk_outen),
	     .io_sclk_out(spi3_1io_sclk_out),
	     .io_miso_outen(spi3_1io_miso_outen),
	     .io_miso_out(spi3_1io_miso_out),
	     .io_ncs_outen(spi3_1io_ncs_outen),
	     .io_ncs_out(spi3_1io_ncs_out),
	     .sb_sspi_interrupt(spi3_sb_sspi_interrupt),
	     .RDY_sb_sspi_interrupt(),
	     .slave_awready(spi3_slave_awready),
	     .slave_wready(spi3_slave_wready),
	     .slave_bvalid(spi3_slave_bvalid),
	     .slave_bresp(spi3_slave_bresp),
	     .slave_arready(spi3_slave_arready),
	     .slave_rvalid(spi3_slave_rvalid),
	     .slave_rresp(spi3_slave_rresp),
	     .slave_rdata(spi3_slave_rdata));
  ...
  assign CAN_FIRE_RL_fabric_rl_rd_xaction_master_to_slave_1 =
	     ...
	     (fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d94 ||
	      !fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d96) &&
	     !fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d106 &&
	     fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d108 ;
  ...
  assign fabric_xactors_to_slaves_2_f_rd_data_D_IN =
	     { spi2_slave_rresp, spi2_slave_rdata } ;
  ...
  // submodule fabric_xactors_to_slaves_2_f_wr_resp
  assign fabric_xactors_to_slaves_2_f_wr_resp_D_IN = spi2_slave_bresp ;
  ...
  assign fabric_xactors_to_slaves_3_f_rd_data_D_IN =
	     { spi3_slave_rresp, spi3_slave_rdata } ;
  ...
  // submodule fabric_xactors_to_slaves_3_f_wr_resp
  assign fabric_xactors_to_slaves_3_f_wr_resp_D_IN = spi3_slave_bresp ;
  ...
  assign spi0_1io_ncs_in_val = spi0_io_ncs_in_val ;
  ...
  assign spi1_1io_ncs_in_val = spi1_io_ncs_in_val ;
  ...
  // submodule spi2
  assign spi2_1io_miso_in_val = spi2_io_miso_in_val ;
  assign spi2_1io_mosi_in_val = spi2_io_mosi_in_val ;
  assign spi2_1io_ncs_in_val = spi2_io_ncs_in_val ;
  assign spi2_1io_sclk_in_val = spi2_io_sclk_in_val ;
  assign spi2_slave_m_arvalid_araddr =
	     fabric_xactors_to_slaves_2_f_rd_addr_D_OUT[36:5] ;
  assign spi2_slave_m_arvalid_arprot =
	     fabric_xactors_to_slaves_2_f_rd_addr_D_OUT[4:2] ;
  assign spi2_slave_m_arvalid_arsize =
	     fabric_xactors_to_slaves_2_f_rd_addr_D_OUT[1:0] ;
  assign spi2_slave_m_arvalid_arvalid =
	     fabric_xactors_to_slaves_2_f_rd_addr_EMPTY_N ;
  assign spi2_slave_m_awvalid_awaddr =
	     fabric_xactors_to_slaves_2_f_wr_addr_D_OUT[36:5] ;
  assign spi2_slave_m_awvalid_awprot =
	     fabric_xactors_to_slaves_2_f_wr_addr_D_OUT[4:2] ;
  assign spi2_slave_m_awvalid_awsize =
	     fabric_xactors_to_slaves_2_f_wr_addr_D_OUT[1:0] ;
  assign spi2_slave_m_awvalid_awvalid =
	     fabric_xactors_to_slaves_2_f_wr_addr_EMPTY_N ;
  assign spi2_slave_m_bready_bready =
	     fabric_xactors_to_slaves_2_f_wr_resp_FULL_N ;
  assign spi2_slave_m_rready_rready =
	     fabric_xactors_to_slaves_2_f_rd_data_FULL_N ;
  assign spi2_slave_m_wvalid_wdata =
	     fabric_xactors_to_slaves_2_f_wr_data_D_OUT[35:4] ;
  assign spi2_slave_m_wvalid_wstrb =
	     fabric_xactors_to_slaves_2_f_wr_data_D_OUT[3:0] ;
  assign spi2_slave_m_wvalid_wvalid =
	     fabric_xactors_to_slaves_2_f_wr_data_EMPTY_N ;

  // submodule spi3
  assign spi3_1io_miso_in_val = spi3_io_miso_in_val ;
  assign spi3_1io_mosi_in_val = spi3_io_mosi_in_val ;
  assign spi3_1io_ncs_in_val = spi3_io_ncs_in_val ;
  assign spi3_1io_sclk_in_val = spi3_io_sclk_in_val ;
  assign spi3_slave_m_arvalid_araddr =
	     fabric_xactors_to_slaves_3_f_rd_addr_D_OUT[36:5] ;
  assign spi3_slave_m_arvalid_arprot =
	     fabric_xactors_to_slaves_3_f_rd_addr_D_OUT[4:2] ;
  assign spi3_slave_m_arvalid_arsize =
	     fabric_xactors_to_slaves_3_f_rd_addr_D_OUT[1:0] ;
  assign spi3_slave_m_arvalid_arvalid =
	     fabric_xactors_to_slaves_3_f_rd_addr_EMPTY_N ;
  assign spi3_slave_m_awvalid_awaddr =
	     fabric_xactors_to_slaves_3_f_wr_addr_D_OUT[36:5] ;
  assign spi3_slave_m_awvalid_awprot =
	     fabric_xactors_to_slaves_3_f_wr_addr_D_OUT[4:2] ;
  assign spi3_slave_m_awvalid_awsize =
	     fabric_xactors_to_slaves_3_f_wr_addr_D_OUT[1:0] ;
  assign spi3_slave_m_awvalid_awvalid =
	     fabric_xactors_to_slaves_3_f_wr_addr_EMPTY_N ;
  assign spi3_slave_m_bready_bready =
	     fabric_xactors_to_slaves_3_f_wr_resp_FULL_N ;
  assign spi3_slave_m_rready_rready =
	     fabric_xactors_to_slaves_3_f_rd_data_FULL_N ;
  assign spi3_slave_m_wvalid_wdata =
	     fabric_xactors_to_slaves_3_f_wr_data_D_OUT[35:4] ;
  assign spi3_slave_m_wvalid_wstrb =
	     fabric_xactors_to_slaves_3_f_wr_data_D_OUT[3:0] ;
  assign spi3_slave_m_wvalid_wvalid =
	     fabric_xactors_to_slaves_3_f_wr_data_EMPTY_N ;

  // remaining internal signals
  assign fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d106 =
	     fabric_xactors_from_masters_0_f_rd_addr_D_OUT[36:5] <
	     32'h00020100 ;
  assign fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d108 =
	     fabric_xactors_from_masters_0_f_rd_addr_D_OUT[36:5] <=
	     32'h000201FF ;
  assign fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d119 =
	     fabric_xactors_from_masters_0_f_rd_addr_D_OUT[36:5] <
	     32'h00020200 ;
  assign fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d121 =
	     fabric_xactors_from_masters_0_f_rd_addr_D_OUT[36:5] <=
	     32'h000202FF ;
  assign fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d124 =
	     (fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d94 ||
	      !fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d96) &&
	     (fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d106 ||
	      !fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d108) &&
	     !fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d119 &&
	     fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d121 ;
  assign fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d133 =
	     fabric_xactors_from_masters_0_f_rd_addr_D_OUT[36:5] <
	     32'h00020300 ;
  assign fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d135 =
	     fabric_xactors_from_masters_0_f_rd_addr_D_OUT[36:5] <=
	     32'h000203FF ;
  assign fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d138 =
	     (fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d106 ||
	      !fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d108) &&
	     (fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d119 ||
	      !fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d121) &&
	     !fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d133 &&
	     fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d135 ;
  assign fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d149 =
	     (fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d106 ||
	      !fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d108) &&
	     (fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d119 ||
	      !fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d121) &&
	     (fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d133 ||
	      !fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d135) ;
  assign fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d94 =
	     fabric_xactors_from_masters_0_f_rd_addr_D_OUT[36:5] <
	     32'h00020000 ;
  assign fabric_xactors_from_masters_0_f_rd_addr_first__ETC___d96 =
	     fabric_xactors_from_masters_0_f_rd_addr_D_OUT[36:5] <=
	     32'h000200FF ;
