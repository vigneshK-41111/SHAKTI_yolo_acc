...
module mkstage0(resetpc,
  ...
  output [34 : 0] icache_to_icache_get;
  ...
  wire [34 : 0] icache_to_icache_get;
  ...
  wire [31 : 0] nextpc__h1326, x_address__h1990, y_avValue__h1640;
  wire [1 : 0] curr_epoch__h1221;
  ...
  // actionvalue method icache_to_icache_get
  assign icache_to_icache_get = ff_to_cache_rv_port1__read[34:0] ;
  assign RDY_icache_to_icache_get = ff_to_cache_rv_port1__read[35] ;
  assign CAN_FIRE_icache_to_icache_get = ff_to_cache_rv_port1__read[35] ;
  ...
  assign ff_to_cache_rv_port0__write_1 =
	     { 1'd1, x_address__h1990, curr_epoch__h1221, rg_fence } ;
  ...
  assign bpu_EN_mav_prediction_response = CAN_FIRE_RL_rl_gen_next_pc ;
  ...
  // remaining internal signals
  assign curr_epoch__h1221 = { rg_eEpoch, rg_wEpoch } ;
  assign nextpc__h1326 = x_address__h1990 + 32'd4 ;
  assign x_address__h1990 = { rg_pc[31:2], 2'd0 } ;
  assign y_avValue__h1640 =
