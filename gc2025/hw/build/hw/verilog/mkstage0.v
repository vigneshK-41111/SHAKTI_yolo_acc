...
module mkstage0(resetpc,
  ...
  output [35 : 0] icache_to_icache_get;
  ...
  output [44 : 0] tx_tx_to_stage1_enq_data;

  // action method s0_bpu_ma_train_bpu
  input  [77 : 0] s0_bpu_ma_train_bpu_td;
  ...
  wire [44 : 0] tx_tx_to_stage1_enq_data;
  wire [35 : 0] icache_to_icache_get;
  ...
  // inlined wires
  wire [36 : 0] ff_to_cache_rv_port0__write_1,
  ...
  wire [31 : 0] rg_pc_port0__write_1,
		rg_pc_port1__read,
  ...
  reg [36 : 0] ff_to_cache_rv;
  wire [36 : 0] ff_to_cache_rv_D_IN;
  ...
  wire [31 : 0] nextpc__h1482,
		x_address__h2247,
		y_avValue__h1811,
		y_avValue_snd__h1869;
  ...
  // actionvalue method icache_to_icache_get
  assign icache_to_icache_get = ff_to_cache_rv_port1__read[35:0] ;
  assign RDY_icache_to_icache_get = ff_to_cache_rv_port1__read[36] ;
  assign CAN_FIRE_icache_to_icache_get = ff_to_cache_rv_port1__read[36] ;
  ...
  assign CAN_FIRE_RL_rl_gen_next_pc =
	     !ff_to_cache_rv[36] && EN_common_ma_reset_done &&
	     bpu_RDY_mav_prediction_response &&
	     tx_tx_to_stage1_enq_rdy_b &&
	     tx_tx_to_stage1_notFull_b &&
	     !rg_initialize &&
  ...
  assign rg_pc_port0__write_1 =
	     rg_sfence ? nextpc__h1482 : y_avValue_snd__h1869 ;
  ...
  assign rg_pc_port1__write_1 =
	     WILL_FIRE_RL_rl_initialize ? resetpc : common_ma_flush_fl[31:0] ;
  ...
  assign nextpc__h1482 = x_address__h2247 + 32'd4 ;
  assign x_address__h2247 = { rg_pc[31:2], 2'd0 } ;
  assign y_avValue__h1811 =
