...
// sb_clint_mtime_put             I    64 unused
...
// EN_sb_clint_mtime_put          I     1 unused
// EN_sb_plic_meip                I     1
...
module mkccore_axi4(resetpc,
  ...
  wire [100 : 0] dmem_send_core_io_resp;
  wire [99 : 0] dmem_send_core_cache_resp_get;
  wire [77 : 0] dmem_receive_core_req_put;
  ...
  wire [34 : 0] imem_put_core_req_put, imem_put_read_mem_resp_put;
  ...
  wire [100 : 0] riscv_s5_cache_ma_io_response_r;
  wire [99 : 0] riscv_s4_cache_memory_response_put;
  wire [77 : 0] riscv_s3_cache_mv_memory_request_get;
  wire [63 : 0] riscv_interrupts_ma_clint_mtime_mtime;
  wire [41 : 0] riscv_s1_icache_inst_response_put;
  wire [34 : 0] riscv_s0_icache_to_icache_get;
  ...
  reg [31 : 0] x_wdata__h2723;
  reg [3 : 0] write_strobe__h2428;
  wire [511 : 0] x__h5481;
  wire [31 : 0] wr_write_req_BITS_31_TO_0__q1;
  wire [8 : 0] x__h5389;
  wire [7 : 0] x__h5426;
  wire [3 : 0] write_strobe__h2430;
  wire [2 : 0] x__h2155, x__h2595, x__h5081, x__h5109;
  wire IF_wr_write_req_20_BIT_32_21_THEN_wr_write_req_ETC___d127;
  ...
  assign MUX_memory_xactor_f_rd_addr_enq_1__SEL_2 =
	     WILL_FIRE_RL_rl_handle_dmem_line_read_request &&
	     (!wr_write_req[32] ||
	      !IF_wr_write_req_20_BIT_32_21_THEN_wr_write_req_ETC___d127) ;
  ...
  assign MUX_memory_xactor_f_rd_addr_enq_1__VAL_1 =
	     { dmem_send_mem_io_req_get[67:36], x__h5081, x__h2595, 14'd1 } ;
  ...
  assign MUX_memory_xactor_f_wr_data_enq_1__VAL_1 =
	     { x_wdata__h2723, write_strobe__h2430, 5'd3 } ;
  ...
  assign MUX_memory_xactor_f_wr_data_enq_1__VAL_3 =
	     { x__h5481[31:0], 8'd240, rg_burst_count == 8'd15 } ;
  assign MUX_rg_burst_count_write_1__VAL_2 =
	     (rg_burst_count == 8'd15) ? 8'd0 : x__h5426 ;
  ...
  // register rg_shift_amount
  assign rg_shift_amount_D_IN = (rg_burst_count == 8'd15) ? 9'd32 : x__h5389 ;
  ...
  assign dmem_receive_core_req_put = riscv_s3_cache_mv_memory_request_get ;
  ...
  // remaining internal signals
  assign IF_wr_write_req_20_BIT_32_21_THEN_wr_write_req_ETC___d127 =
	     wr_write_req_BITS_31_TO_0__q1[31:20] ==
	     dmem_send_mem_rd_req_get[42:31] ;
  assign wr_write_req_BITS_31_TO_0__q1 = wr_write_req[31:0] ;
  assign write_strobe__h2430 =
	     write_strobe__h2428 << dmem_send_mem_io_req_get[37:36] ;
  assign x__h2155 = { 2'd2, riscv_csrs_mv_curr_priv[1] } ;
  assign x__h2595 = { 1'd0, dmem_send_mem_io_req_get[1:0] } ;
  assign x__h5081 = { 2'd0, riscv_csrs_mv_curr_priv[1] } ;
  assign x__h5109 = { 1'd0, dmem_send_mem_wr_req[1:0] } ;
  assign x__h5389 = rg_shift_amount + 9'd32 ;
  assign x__h5426 = rg_burst_count + 8'd1 ;
  assign x__h5481 = dmem_send_mem_wr_req[522:11] >> rg_shift_amount ;
  always@(dmem_send_mem_io_req_get)
  begin
    case (dmem_send_mem_io_req_get[1:0])
      2'd0: x_wdata__h2723 = {4{dmem_send_mem_io_req_get[10:3]}};
      2'd1: x_wdata__h2723 = {2{dmem_send_mem_io_req_get[18:3]}};
      default: x_wdata__h2723 = dmem_send_mem_io_req_get[34:3];
    endcase
  end
  always@(dmem_send_mem_io_req_get)
  begin
    case (dmem_send_mem_io_req_get[1:0])
      2'd0: write_strobe__h2428 = 4'b0001;
      2'd1: write_strobe__h2428 = 4'b0011;
      default: write_strobe__h2428 = 4'hF;
    endcase
  end
