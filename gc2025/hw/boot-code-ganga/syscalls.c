...
#else
#define UART_STATUS_REG 0x1130C
#define UART_TX_REG 0x11304

#define STS_TX_FULL 1 << 1

volatile unsigned short * uart_status = (volatile unsigned short *)  UART_STATUS_REG;
volatile unsigned char * uart_tx = (volatile unsigned short *)  UART_TX_REG;
