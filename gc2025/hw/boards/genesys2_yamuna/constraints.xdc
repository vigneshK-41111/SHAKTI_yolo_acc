...
## LEDs
# set_property -dict { PACKAGE_PIN T28   IOSTANDARD LVCMOS33 } [get_ports { io7_cell }]; #IO_L11N_T1_SRCC_14 Sch=led[0]
# set_property -dict { PACKAGE_PIN V19   IOSTANDARD LVCMOS33 } [get_ports { io8_cell }]; #IO_L19P_T3_A10_D26_14 Sch=led[1]
# set_property -dict { PACKAGE_PIN U30   IOSTANDARD LVCMOS33 } [get_ports { io9_cell }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=led[2]
# set_property -dict { PACKAGE_PIN U29   IOSTANDARD LVCMOS33 } [get_ports { io10_cell }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=led[3]
# set_property -dict { PACKAGE_PIN V20   IOSTANDARD LVCMOS33 } [get_ports { gpio_4 }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=led[4]
# set_property -dict { PACKAGE_PIN V26   IOSTANDARD LVCMOS33 } [get_ports { io12_cell }]; #IO_L16P_T2_CSI_B_14 Sch=led[5]
# set_property -dict { PACKAGE_PIN W24   IOSTANDARD LVCMOS33 } [get_ports { io13_cell }]; #IO_L20N_T3_A07_D23_14 Sch=led[6]
# set_property -dict { PACKAGE_PIN W23   IOSTANDARD LVCMOS33 } [get_ports { gpio_7 }]; #IO_L20P_T3_A08_D24_14 Sch=led[7]

## Switches
# set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS33 } [get_ports { gpio_8 }]; #IO_0_17 Sch=sw[0]
# set_property -dict { PACKAGE_PIN G25   IOSTANDARD LVCMOS33 } [get_ports { io16_cell }]; #IO_25_16 Sch=sw[1]
# set_property -dict { PACKAGE_PIN H24   IOSTANDARD LVCMOS33 } [get_ports { io17_cell }]; #IO_L19P_T3_16 Sch=sw[2]
# set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports { io18_cell }]; #IO_L6P_T0_17 Sch=sw[3]
# set_property -dict { PACKAGE_PIN N19   IOSTANDARD LVCMOS33 } [get_ports { io19_cell }]; #IO_L19P_T3_A22_15 Sch=sw[4]
# set_property -dict { PACKAGE_PIN P19   IOSTANDARD LVCMOS33 } [get_ports { io20_cell }]; #IO_25_15 Sch=sw[5]
# set_property -dict { PACKAGE_PIN P26   IOSTANDARD LVCMOS33 } [get_ports { gpio_14 }]; #IO_L10P_T1_D14_14 Sch=sw[6]
# set_property -dict { PACKAGE_PIN P27   IOSTANDARD LVCMOS33 } [get_ports { gpio_15 }]; #IO_L8P_T1_D11_14 Sch=sw[7]
...
# set_property -dict { PACKAGE_PIN A28   IOSTANDARD LVCMOS12 } [get_ports { io9_cell }]; #IO_L9N_T1_DQS_16 Sch=fmc_la_n[09]
# set_property -dict { PACKAGE_PIN B28   IOSTANDARD LVCMOS12 } [get_ports { io10_cell }]; #IO_L9P_T1_DQS_16 Sch=fmc_la_p[09]
# set_property -dict { PACKAGE_PIN A27   IOSTANDARD LVCMOS12 } [get_ports { io7_cell }]; #IO_L7N_T1_16 Sch=fmc_la_n[10]
# set_property -dict { PACKAGE_PIN B27   IOSTANDARD LVCMOS12 } [get_ports { io8_cell }]; #IO_L7P_T1_16 Sch=fmc_la_p[10]
# set_property -dict { PACKAGE_PIN A26   IOSTANDARD LVCMOS12 } [get_ports { uart0_SOUT }]; #IO_L10N_T1_16 Sch=fmc_la_n[11]
# set_property -dict { PACKAGE_PIN A25   IOSTANDARD LVCMOS12 } [get_ports { uart0_SIN  }]; #IO_L10P_T1_16 Sch=fmc_la_p[11]
