...
if { [get_ips -quiet kcu105mig] eq "" } {
    create_ip -vendor xilinx.com -library ip -version 2.2 -name ddr4 -module_name kcu105mig 
} else {
    reset_run kcu105mig_synth_1
}
...
generate_target {instantiation_template} [get_ips kcu105mig]
create_ip_run [get_ips kcu105mig]
