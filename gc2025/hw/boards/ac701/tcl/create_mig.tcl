...
if { $axibuswidth eq "BUS_WIDTH128" } {
	set_property CONFIG.XML_INPUT_FILE [file normalize $home_dir/tcl/ac701_mig_128.prj] [get_ips mig_ddr3]
}
if { $axibuswidth eq "BUS_WIDTH64" } {
    set_property CONFIG.XML_INPUT_FILE [file normalize $home_dir/tcl/ac701_mig_64.prj] [get_ips mig_ddr3]
}
if { $axibuswidth eq "BUS_WIDTH32" } {
    set_property CONFIG.XML_INPUT_FILE [file normalize $home_dir/tcl/ac701_mig_32.prj] [get_ips mig_ddr3]
}
