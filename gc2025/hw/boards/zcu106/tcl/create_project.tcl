...
if { $argc != 6 } {
  ...
  puts " -tclargs <top-module> <xczu7ev-ffvc1156-2-e> <riscv-isa> <jtag_type> <verilogdir> <axibuswidth>"
  exit 2
} else {
...
import_ip $ip_project_dir/manage_ip.srcs/sources_1/ip/zcu106mig/zcu106mig.xci
