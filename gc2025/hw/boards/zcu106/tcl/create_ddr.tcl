...
if { [get_ips -quiet zcu106mig] eq "" } {
    create_ip -vendor xilinx.com -library ip -version 2.2 -name ddr4 -module_name zcu106mig 
} else {
    reset_run zcu106mig_synth_1
}
...
generate_target {instantiation_template} [get_ips zcu106mig]
create_ip_run [get_ips zcu106mig]
