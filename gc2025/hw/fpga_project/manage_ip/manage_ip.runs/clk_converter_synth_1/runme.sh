...
HD_PWD='/scratch1/iot/new/gc2025/hw/fpga_project/manage_ip/manage_ip.runs/clk_converter_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_converter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_converter.tcl
