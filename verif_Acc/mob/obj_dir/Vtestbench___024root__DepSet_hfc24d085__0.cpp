...
void Vtestbench___024root___eval_triggers__act(Vtestbench___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.set(2U, ((IData)(vlSelf->tb__DOT__s_bvalid) 
                                     != (IData)(vlSelf->__Vtrigprevexpr___TOP__tb__DOT__s_bvalid__0)));
    vlSelf->__Vtrigprevexpr___TOP__tb__DOT__clk__0 
        = vlSelf->tb__DOT__clk;
    vlSelf->__Vtrigprevexpr___TOP__tb__DOT__s_bvalid__0 
        = vlSelf->tb__DOT__s_bvalid;
