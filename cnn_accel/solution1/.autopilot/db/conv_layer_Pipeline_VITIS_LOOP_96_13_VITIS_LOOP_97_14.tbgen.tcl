set moduleName conv_layer_Pipeline_VITIS_LOOP_96_13_VITIS_LOOP_97_14
set isTopModule 0
...
set cdfgNum 15
set C_modelName {conv_layer_Pipeline_VITIS_LOOP_96_13_VITIS_LOOP_97_14}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict tile_out { MEM_WIDTH 7 MEM_SIZE 2048 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ ty int 31 regular  }
	{ H int 32 regular  }
	{ sext_ln37 int 32 regular  }
	{ tile_out int 7 regular {array 2048 { 1 1 } 1 1 }  }
	{ tx int 31 regular  }
	{ zext_ln37 int 4 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "ty", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "tile_out", "interface" : "memory", "bitwidth" : 7, "direction" : "READONLY"} , 
 	{ "Name" : "tx", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln37", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "output_r", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control"},"direction": "READONLY"},{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "READWRITE"}]}]} ]}
...
set portList { 
	...
	{ m_axi_gmem_0_WDATA sc_out sc_lv 8 signal 7 } 
	{ m_axi_gmem_0_WSTRB sc_out sc_lv 1 signal 7 } 
	...
	{ m_axi_gmem_0_RDATA sc_in sc_lv 8 signal 7 } 
	...
	{ ty sc_in sc_lv 31 signal 0 } 
	{ H sc_in sc_lv 32 signal 1 } 
	{ sext_ln37 sc_in sc_lv 32 signal 2 } 
	{ tile_out_address0 sc_out sc_lv 11 signal 3 } 
	{ tile_out_ce0 sc_out sc_logic 1 signal 3 } 
	{ tile_out_q0 sc_in sc_lv 7 signal 3 } 
	{ tile_out_address1 sc_out sc_lv 11 signal 3 } 
	{ tile_out_ce1 sc_out sc_logic 1 signal 3 } 
	{ tile_out_q1 sc_in sc_lv 7 signal 3 } 
	{ tx sc_in sc_lv 31 signal 4 } 
	{ zext_ln37 sc_in sc_lv 4 signal 5 } 
	{ output_r sc_in sc_lv 64 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tile_out_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "tile_out", "role": "q0" }} , 
 	{ "name": "tile_out_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "tile_out", "role": "address1" }} , 
 	{ "name": "tile_out_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "tile_out", "role": "ce1" }} , 
 	{ "name": "tile_out_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "tile_out", "role": "q1" }} , 
 	{ "name": "tx", "direction": "in", "datatype": "sc_lv", "bitwidth":31, "type": "signal", "bundle":{"name": "tx", "role": "default" }} , 
 	{ "name": "zext_ln37", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln37", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32s_60_2_1_U213", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	tile_out { ap_memory {  { tile_out_address0 mem_address 1 11 }  { tile_out_ce0 mem_ce 1 1 }  { tile_out_q0 mem_dout 0 7 }  { tile_out_address1 MemPortADDR2 1 11 }  { tile_out_ce1 MemPortCE2 1 1 }  { tile_out_q1 MemPortDOUT2 0 7 } } }
	tx { ap_none {  { tx in_data 0 31 } } }
	zext_ln37 { ap_none {  { zext_ln37 in_data 0 4 } } }
