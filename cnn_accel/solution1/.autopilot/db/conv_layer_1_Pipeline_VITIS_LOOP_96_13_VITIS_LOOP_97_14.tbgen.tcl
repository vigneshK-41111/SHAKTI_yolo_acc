set moduleName conv_layer_1_Pipeline_VITIS_LOOP_96_13_VITIS_LOOP_97_14
set isTopModule 0
...
set cdfgNum 15
set C_modelName {conv_layer.1_Pipeline_VITIS_LOOP_96_13_VITIS_LOOP_97_14}
...
set C_modelArgMapList {[ 
	{ "Name" : "ty", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln37", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln37 sc_in sc_lv 5 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln37", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "zext_ln37", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32s_59_2_1_U1054", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	zext_ln37 { ap_none {  { zext_ln37 in_data 0 5 } } }
