...
#line 18 "/scratch1/iot/run_hls.tcl"
...
#pragma HLS INTERFACE m_axi port=input bundle=gmem depth=(416 * 416 * 16) offset=slave
#pragma HLS INTERFACE m_axi port=output bundle=gmem depth=(416 * 416 * 16) offset=slave
...
#pragma HLS INTERFACE ap_ctrl_hs port=return
 ...
 if (size > 0) {
    ...
    int8_t tile_in[32][32][3];
#pragma HLS BIND_STORAGE variable=tile_in type=ram_t2p impl=bram

 int8_t tile_out[32][32][16];
#pragma HLS BIND_STORAGE variable=tile_out type=ram_t2p impl=bram


 VITIS_LOOP_35_1: for (int ty = 0; ty < size; ty += 32) {
#pragma HLS LOOP_TRIPCOUNT min=1 max=416

 VITIS_LOOP_38_2: for (int tx = 0; tx < size; tx += 32) {
#pragma HLS LOOP_TRIPCOUNT min=1 max=416


 VITIS_LOOP_42_3: for (int y = 0; y < 32; y++) {
                VITIS_LOOP_43_4: for (int x = 0; x < 32; x++) {
#pragma HLS PIPELINE II=1
 ...
 int gy = ty + y;
            ...
            VITIS_LOOP_65_5: for (int y = 0; y < 32; y++) {
                VITIS_LOOP_66_6: for (int x = 0; x < 32; x++) {
#pragma HLS PIPELINE II=1

 VITIS_LOOP_69_7: for (int c = 0; c < 16; c++) {
            ...
            VITIS_LOOP_83_8: for (int y = 0; y < 32; y++) {
                VITIS_LOOP_84_9: for (int x = 0; x < 32; x++) {
#pragma HLS PIPELINE II=1
 ...
 int gy = ty + y;
                    ...
                    if (gy < size && gx < size) {
                        int idx = (gy * size + gx) * 16;

                        VITIS_LOOP_93_10: for (int c = 0; c < 16; c++) {
