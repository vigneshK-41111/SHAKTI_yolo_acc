set moduleName cnn_accel_Pipeline_VITIS_LOOP_42_3_VITIS_LOOP_43_4
set isTopModule 0
...
set cdfgNum 6
set C_modelName {cnn_accel_Pipeline_VITIS_LOOP_42_3_VITIS_LOOP_43_4}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict tile_in { MEM_WIDTH 8 MEM_SIZE 1024 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict tile_in_1 { MEM_WIDTH 8 MEM_SIZE 1024 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict tile_in_2 { MEM_WIDTH 8 MEM_SIZE 1024 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem int 8 regular {axi_master 0}  }
	{ input_r int 64 regular  }
	{ ty int 31 regular  }
	{ size int 32 regular  }
	{ sext_ln35 int 32 regular  }
	{ tile_in int 8 regular {array 1024 { 0 3 } 0 1 }  }
	{ tile_in_1 int 8 regular {array 1024 { 0 3 } 0 1 }  }
	{ tile_in_2 int 8 regular {array 1024 { 0 3 } 0 1 }  }
	{ tx int 31 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control_r"},"direction": "READONLY"},{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control_r"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "sext_ln35", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln35", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sext_ln35", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32s_62_2_1_U1", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sext_ln35 { ap_none {  { sext_ln35 in_data 0 32 } } }
	tile_in { ap_memory {  { tile_in_address0 mem_address 1 10 }  { tile_in_ce0 mem_ce 1 1 }  { tile_in_we0 mem_we 1 1 }  { tile_in_d0 mem_din 1 8 } } }
	tile_in_1 { ap_memory {  { tile_in_1_address0 mem_address 1 10 }  { tile_in_1_ce0 mem_ce 1 1 }  { tile_in_1_we0 mem_we 1 1 }  { tile_in_1_d0 mem_din 1 8 } } }
	tile_in_2 { ap_memory {  { tile_in_2_address0 mem_address 1 10 }  { tile_in_2_ce0 mem_ce 1 1 }  { tile_in_2_we0 mem_we 1 1 }  { tile_in_2_d0 mem_din 1 8 } } }
