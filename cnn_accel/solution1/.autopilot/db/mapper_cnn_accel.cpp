...
using hls::sim::Byte;
extern "C" void cnn_accel(Byte<1>*, int, int, int);
extern "C" void apatb_cnn_accel_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r, int __xlx_apatb_param_size) {
