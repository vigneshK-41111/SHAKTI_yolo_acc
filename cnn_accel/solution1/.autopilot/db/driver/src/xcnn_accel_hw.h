...
#define XCNN_ACCEL_CONTROL_R_ADDR_INPUT_R_DATA  0x10
#define XCNN_ACCEL_CONTROL_R_BITS_INPUT_R_DATA  64
#define XCNN_ACCEL_CONTROL_R_ADDR_OUTPUT_R_DATA 0x1c
#define XCNN_ACCEL_CONTROL_R_BITS_OUTPUT_R_DATA 64
