...
set name cnn_accel_mul_6ns_15ns_19_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name cnn_accel_urem_19ns_10ns_9_23_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cnn_accel_mac_muladd_7ns_7ns_19ns_19_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
